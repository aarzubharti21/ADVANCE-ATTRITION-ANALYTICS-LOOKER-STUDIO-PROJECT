...
# Total Employees
Displays the total number of employees included in the analysis.
Value: 1,470

# Total Attrition Count
Represents the total number of employees who left the organization.
Value: 237
...
Shows the average age of employees.
Value: 36.92 Years
...
The second dashboard page focuses on detailed attrition analysis.

# Attrition Rate by Department
Compares attrition percentages across organizational departments.

The dashboard shows that Sales experiences the highest attrition rate, followed by Human Resources, while Research & Development records the lowest among the three departments.

# Attrition Rate by Age Group
Employee turnover is analyzed across different age categories.

The visualization indicates that employees between 18–25 years have the highest attrition rate, suggesting younger employees are more likely to leave the organization.

# Attrition Rate by Income Bracket
Employees are grouped according to salary ranges.

The dashboard suggests that employees in the lowest income bracket experience the highest attrition, while higher-income employees demonstrate better retention.

# Attrition by Job Satisfaction
The dashboard compares attrition across different job satisfaction levels.

Employees with low job satisfaction exhibit significantly higher turnover than those reporting higher satisfaction levels.

# Gender and Department Attrition Matrix
An interactive pivot table compares male and female attrition rates within each department, enabling HR managers to identify department-specific retention trends.
